<?php include('../audio_headerForSubfolders.php'); ?>
...
<p>To complete this experiment, you'll need to have working sound. Click the "play" button on the right-hand side of the page, then type the word that you hear. (Hint: it will be a food and be spoken in an American accent.)</p>
