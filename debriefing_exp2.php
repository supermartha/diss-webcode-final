...
<li class="paid bar" id="posh_BATH_char" style="height: 0px;" data-tooltip=""> </li>
</ul>
</li>
...
<li class="paid bar" id="fakePosh_BATH_char" style="height: 0px;" data-tooltip=""> </li>
</ul>
</li>
...
<li class="paid bar" id="wc_BATH_char" style="height: 0px;" data-tooltip=""> </li>
</ul>
</li>
...
<table>
<tr>
<td class="nonmerged"> </td> <td class="label">our predictions</td> <td class="merged"></td> <td class="label" id="bathCharResults"><div class="pinkButton" onclick="showCharResults('bath') ">Show your results</div></td>
</tr>
</table>
<br /><br />
<hr />
...
<li class="paid bar" id="posh_GAS_char" style="height: 0px;" data-tooltip=""> </li>
</ul>
</li>
...
<li class="paid bar" id="fakePosh_GAS_char" style="height: 0px;" data-tooltip=""> </li>
</ul>
</li>
...
<li class="paid bar" id="wc_GAS_char" style="height: 0px;" data-tooltip=""> </li>
</ul>
</li>
...
<table>
<tr>
<td class="nonmerged"> </td> <td class="label">our predictions</td> <td class="merged"></td> <td class="label" id="gasCharResults"><div class="pinkButton" onclick="showCharResults('gas') ">Show your results</div></td>
</tr>
</table>
...
<p>In the third part of the experiment, we asked you to listen to two versions of the same sentence. The sentences we were interested in contained BATH or GAS words. As you probably noticed, in one version the word was pronounced with long-ah, and the other with short-a.</p>
