...
function play(audioName) {
  ...
  var max = 7; // how many stimuli should each participant hear
  var count = 0;
...
<br /><br />
<progress max="7" value="1" id="progressbar"></progress>  <span class="progress_count"> <span id="completed_count">1</span> / 7 </span>
<br /><br />
