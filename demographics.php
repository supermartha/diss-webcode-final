...
var count = 0
function addPlace() {
    document.getElementById('add_another').innerHTML = 'Add another location'
  if (count == 0) {
  document.getElementById('more_locations').innerHTML = '<table><tr><td> city:</td><td> <input type="text" name="city2" /></td></tr><tr><td>state/province: </td><td><input type="text" name="state2"> </td></tr><tr>  <td>country (if not US): </td><td><input type="text" name="country2"></td></tr><tr>  <td>ages lived there: </td><td><input type="text" name="age2"></td></tr></table><br />';
  document.getElementById('add_age1').innerHTML = 'ages lived there:';
  document.getElementById('add_age2').innerHTML = '<input type="text" name="age2">'; }
  if (count == 1) {document.getElementById('more_locations2').innerHTML = '<table><tr><td> city:</td><td> <input type="text" name="city3" /></td></tr><tr><td>state/province: </td><td><input type="text" name="state3"> </td></tr><tr>  <td>country (if not US): </td><td><input type="text" name="country3"></td></tr><tr>  <td>ages lived there: </td><td><input type="text" name="age3"></td></tr></table><br />'}
    if (count == 2) {document.getElementById('more_locations3').innerHTML = '<table><tr><td> city:</td><td> <input type="text" name="city4" /></td></tr><tr><td>state/province: </td><td><input type="text" name="state4"> </td></tr><tr>  <td>country (if not US): </td><td><input type="text" name="country4"></td></tr><tr>  <td>ages lived there: </td><td><input type="text" name="age4"></td></tr></table><br />'}
        if (count == 3) {document.getElementById('more_locations4').innerHTML = '<table><tr><td> city:</td><td> <input type="text" name="city5" /></td></tr><tr><td>state/province: </td><td><input type="text" name="state5"> </td></tr><tr>  <td>country (if not US): </td><td><input type="text" name="country5"></td></tr><tr>  <td>ages lived there: </td><td><input type="text" name="age5"></td></tr></table><br />';
...
<p class="question">Please list all of the places you have lived since you were 5 years old (including where you live now).</p>
<table>
