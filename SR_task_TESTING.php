...
<header>
	...
	<link rel="stylesheet" type="text/css" href="style_ie_TESTING.css" />
...
<table style="width: 100%; ">
	<tr> <td class="adjectiveRight"> strongly disagree </td> <td><div class="normingSlider"> <input type='range' data-type="range" min=0 max=100 value=0 id="wealthy" /></div> </td> <td  class="adjective"> strongly agree </td> </tr>
</table>
