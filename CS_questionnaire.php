...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $filename = 'results/CSquestionnaire_' . $_COOKIE["ParticipantID"];
...
<a href="CS_final.php"><input type="submit" class="submit"></a>
